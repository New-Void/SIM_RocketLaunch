...
/* Created 2023/01/22 14:32:19 bahram $ */
#include "../S_source.hh"
...
int RocketSimObject::call_function ( Trick::JobData * curr_job ) {
...
double RocketSimObject::call_function_double ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 4:
            trick_ret = rocket.rocket_stage1() ;
            break ;
        case 5:
            trick_ret = rocket.rocket_stage2() ;
            break ;
        case 6:
            trick_ret = rocket.rocket_stage3() ;
            break ;
        case 7:
            trick_ret = rocket.rocket_orbit() ;
            break ;
        case 8:
            trick_ret = rocket.rocket_impact() ;
            break ;
        default:
            trick_ret = 0.0 ;
            break ;
...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_EXEC_LINK_LIBS"] = "-lpthread -L/usr/lib/python3.10/config-3.10-x86_64-linux-gnu -L/usr/lib/x86_64-linux-gnu -lpython3.10 -lcrypt -ldl  -lm -lm  -lpython3.10 -lcrypt -ldl  -lm -lm    -ludunits2 -lrt -lm -ldl";
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 19.6.0-beta, Sun Jan 22 14:32:19 2023" ) ;
    exec_set_build_date( "Sun Jan 22 14:32:19 2023" ) ;
    ...
    TMM_declare_ext_var(&dyn, TRICK_STRUCTURED,"RocketSimObject", 0, "dyn", 0, NULL) ;
