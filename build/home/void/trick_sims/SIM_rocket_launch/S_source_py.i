%module mb7c3ca89939274de2120b11c785a840a
...
%{
#include "/home/void/trick_sims/SIM_rocket_launch/S_source.hh"
%}
...
%trick_swig_class_typemap(RocketSimObject, RocketSimObject)
...
%import "build/home/void/trick_sims/SIM_rocket_launch/models/rocket/include/Rocket_py.i"
...
class MessageSimObject : public Trick::SimObject {
    ...
    public:
        ...
        MessageSimObject() {
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 11, "shutdown", NULL, 1, "mtcout.shutdown", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 12, "shutdown", NULL, 1, "mdevice.shutdown", "", 60000) ;
            job->add_tag("TRK") ;
...
class VariableServerSimObject : public Trick::SimObject {
    ...
    public:
        ...
        VariableServerSimObject() {
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 8, "top_of_frame", NULL, 1, "vs.copy_data_top", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 9, "automatic_last", NULL, 1, "vs.copy_data_scheduled", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 10, "freeze_init", NULL, 1, "vs.freeze_init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 11, "freeze_automatic", NULL, 1, "vs.copy_data_freeze_scheduled", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 12, "freeze", NULL, 1, "vs.copy_data_freeze", "", 60000) ;
            job->add_tag("TRK") ;
...
class RocketSimObject : public Trick::SimObject {
    ...
    {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "rocket.default_data", "", 60000) ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "rocket.initial_data", "", 60000) ;
            job = this->add_job(0, 2, "derivative", NULL, 1, "rocket.rocket_deriv", "", 60000) ;
            job = this->add_job(0, 3, "integration", NULL, 1, "rocket.rocket_integ", "", 60000) ;
            job = this->add_job(0, 4, "dynamic_event", NULL, 1, "rocket.rocket_stage1", "", 60000) ;
            job = this->add_job(0, 5, "dynamic_event", NULL, 1, "rocket.rocket_stage2", "", 60000) ;
            job = this->add_job(0, 6, "dynamic_event", NULL, 1, "rocket.rocket_stage3", "", 60000) ;
            job = this->add_job(0, 7, "dynamic_event", NULL, 1, "rocket.rocket_orbit", "", 60000) ;
            job = this->add_job(0, 8, "dynamic_event", NULL, 1, "rocket.rocket_impact", "", 60000) ;
            job = this->add_job(0, 9, "shutdown", NULL, 1, "rocket.shutdown", "", 60000) ;
    }
...
#define TRICK_SWIG_DEFINED_RocketSimObject
...
#endif
#ifdef TRICK_SWIG_DEFINED_RocketSimObject
%trick_cast_as(RocketSimObject, RocketSimObject)
#endif
