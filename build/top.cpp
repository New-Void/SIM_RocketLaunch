...
#define SWIGTYPE_p_InjectorSimObject swig_types[15]
#define SWIGTYPE_p_InputProcessorSimObject swig_types[16]
#define SWIGTYPE_p_InstrumentationSimObject swig_types[17]
#define SWIGTYPE_p_IntegLoopSimObject swig_types[18]
#define SWIGTYPE_p_Integrator_type swig_types[19]
#define SWIGTYPE_p_JITSimObject swig_types[20]
#define SWIGTYPE_p_Language swig_types[21]
#define SWIGTYPE_p_MESSAGE_TYPE swig_types[22]
#define SWIGTYPE_p_MM_ERROR_TYPE swig_types[23]
#define SWIGTYPE_p_MS_SIM_COMMAND swig_types[24]
#define SWIGTYPE_p_MasterSlaveSimObject swig_types[25]
#define SWIGTYPE_p_MemoryManagerSimObject swig_types[26]
#define SWIGTYPE_p_MessageSimObject swig_types[27]
#define SWIGTYPE_p_MonteCarloSimObject swig_types[28]
#define SWIGTYPE_p_NAME_TO_ATTR swig_types[29]
#define SWIGTYPE_p_REF2 swig_types[30]
#define SWIGTYPE_p_REF_TYPE swig_types[31]
#define SWIGTYPE_p_REGULA_FALSI swig_types[32]
#define SWIGTYPE_p_RTSyncSimObject swig_types[33]
#define SWIGTYPE_p_Regula_Falsi swig_types[34]
#define SWIGTYPE_p_RocketSimObject swig_types[35]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__top

#else
#  define SWIG_init    init_top

#endif
#define SWIG_name    "_top"
...
extern "C" {
#endif
SWIGINTERN int Swig_var_trick_sys_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable trick_sys is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_trick_sys_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_sys), SWIGTYPE_p_SysSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_mc_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_MonteCarloSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_mc""' of type '""MonteCarloSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_mc""' of type '""MonteCarloSimObject""'");
    } else {
      MonteCarloSimObject * temp;
      temp  = reinterpret_cast< MonteCarloSimObject * >(argp);
      trick_mc = *temp;
...
SWIGINTERN PyObject *Swig_var_trick_mc_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_mc), SWIGTYPE_p_MonteCarloSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_mm_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_MemoryManagerSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_mm""' of type '""MemoryManagerSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_mm""' of type '""MemoryManagerSimObject""'");
    } else {
      MemoryManagerSimObject * temp;
      temp  = reinterpret_cast< MemoryManagerSimObject * >(argp);
      trick_mm = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_mm_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_mm), SWIGTYPE_p_MemoryManagerSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_cpr_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_CheckPointRestartSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_cpr""' of type '""CheckPointRestartSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_cpr""' of type '""CheckPointRestartSimObject""'");
    } else {
      CheckPointRestartSimObject * temp;
      temp  = reinterpret_cast< CheckPointRestartSimObject * >(argp);
      trick_cpr = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_cpr_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_cpr), SWIGTYPE_p_CheckPointRestartSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_sie_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_SieSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_sie""' of type '""SieSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_sie""' of type '""SieSimObject""'");
    } else {
      SieSimObject * temp;
      temp  = reinterpret_cast< SieSimObject * >(argp);
      trick_sie = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_sie_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_sie), SWIGTYPE_p_SieSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_cmd_args_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_CommandLineArgumentsSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_cmd_args""' of type '""CommandLineArgumentsSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_cmd_args""' of type '""CommandLineArgumentsSimObject""'");
    } else {
      CommandLineArgumentsSimObject * temp;
      temp  = reinterpret_cast< CommandLineArgumentsSimObject * >(argp);
      trick_cmd_args = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_cmd_args_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_cmd_args), SWIGTYPE_p_CommandLineArgumentsSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_message_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable trick_message is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_trick_message_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_message), SWIGTYPE_p_MessageSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_jit_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_JITSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_jit""' of type '""JITSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_jit""' of type '""JITSimObject""'");
    } else {
      JITSimObject * temp;
      temp  = reinterpret_cast< JITSimObject * >(argp);
      trick_jit = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_jit_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_jit), SWIGTYPE_p_JITSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_ip_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_InputProcessorSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_ip""' of type '""InputProcessorSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_ip""' of type '""InputProcessorSimObject""'");
    } else {
      InputProcessorSimObject * temp;
      temp  = reinterpret_cast< InputProcessorSimObject * >(argp);
      trick_ip = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_ip_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_ip), SWIGTYPE_p_InputProcessorSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_em_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_EventManagerSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_em""' of type '""EventManagerSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_em""' of type '""EventManagerSimObject""'");
    } else {
      EventManagerSimObject * temp;
      temp  = reinterpret_cast< EventManagerSimObject * >(argp);
      trick_em = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_em_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_em), SWIGTYPE_p_EventManagerSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_vs_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable trick_vs is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_trick_vs_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_vs), SWIGTYPE_p_VariableServerSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_data_record_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable trick_data_record is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_trick_data_record_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_data_record), SWIGTYPE_p_DataRecordDispatcherSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_real_time_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_RTSyncSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_real_time""' of type '""RTSyncSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_real_time""' of type '""RTSyncSimObject""'");
    } else {
      RTSyncSimObject * temp;
      temp  = reinterpret_cast< RTSyncSimObject * >(argp);
      trick_real_time = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
  return 0;
...
SWIGINTERN PyObject *Swig_var_trick_real_time_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_real_time), SWIGTYPE_p_RTSyncSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_frame_log_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable trick_frame_log is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_trick_frame_log_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_frame_log), SWIGTYPE_p_FrameLogSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_master_slave_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_MasterSlaveSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_master_slave""' of type '""MasterSlaveSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_master_slave""' of type '""MasterSlaveSimObject""'");
    } else {
      MasterSlaveSimObject * temp;
      temp  = reinterpret_cast< MasterSlaveSimObject * >(argp);
      trick_master_slave = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
  return 0;
...
SWIGINTERN PyObject *Swig_var_trick_master_slave_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_master_slave), SWIGTYPE_p_MasterSlaveSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_instruments_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_InstrumentationSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_instruments""' of type '""InstrumentationSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_instruments""' of type '""InstrumentationSimObject""'");
    } else {
      InstrumentationSimObject * temp;
      temp  = reinterpret_cast< InstrumentationSimObject * >(argp);
      trick_instruments = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
  return 0;
...
SWIGINTERN PyObject *Swig_var_trick_instruments_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_instruments), SWIGTYPE_p_InstrumentationSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_inject_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_InjectorSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_inject""' of type '""InjectorSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_inject""' of type '""InjectorSimObject""'");
    } else {
      InjectorSimObject * temp;
      temp  = reinterpret_cast< InjectorSimObject * >(argp);
      trick_inject = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_inject_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_inject), SWIGTYPE_p_InjectorSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_zero_conf_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_ZeroconfSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_zero_conf""' of type '""ZeroconfSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_zero_conf""' of type '""ZeroconfSimObject""'");
    } else {
      ZeroconfSimObject * temp;
      temp  = reinterpret_cast< ZeroconfSimObject * >(argp);
      trick_zero_conf = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
  return 0;
...
SWIGINTERN PyObject *Swig_var_trick_zero_conf_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_zero_conf), SWIGTYPE_p_ZeroconfSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_utest_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_UnitTestSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_utest""' of type '""UnitTestSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_utest""' of type '""UnitTestSimObject""'");
    } else {
      UnitTestSimObject * temp;
      temp  = reinterpret_cast< UnitTestSimObject * >(argp);
      trick_utest = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_utest_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_utest), SWIGTYPE_p_UnitTestSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_trick_udunits_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_UdUnitsSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""trick_udunits""' of type '""UdUnitsSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""trick_udunits""' of type '""UdUnitsSimObject""'");
    } else {
      UdUnitsSimObject * temp;
      temp  = reinterpret_cast< UdUnitsSimObject * >(argp);
      trick_udunits = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_trick_udunits_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&trick_udunits), SWIGTYPE_p_UdUnitsSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_dyn_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_RocketSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""dyn""' of type '""RocketSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""dyn""' of type '""RocketSimObject""'");
    } else {
      RocketSimObject * temp;
      temp  = reinterpret_cast< RocketSimObject * >(argp);
      dyn = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_dyn_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&dyn), SWIGTYPE_p_RocketSimObject,  0 );
  return pyobj;
}


SWIGINTERN int Swig_var_dyn_integloop_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_IntegLoopSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""dyn_integloop""' of type '""IntegLoopSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""dyn_integloop""' of type '""IntegLoopSimObject""'");
    } else {
      IntegLoopSimObject * temp;
      temp  = reinterpret_cast< IntegLoopSimObject * >(argp);
      dyn_integloop = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_dyn_integloop_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&dyn_integloop), SWIGTYPE_p_IntegLoopSimObject,  0 );
  return pyobj;
}
...
static swig_type_info _swigt__p_IntegLoopSimObject = {"_p_IntegLoopSimObject", "IntegLoopSimObject *", 0, 0, (void*)0, 0};
...
# endif
  ...
  Py_DECREF(globals);
  SWIG_addvarlink(globals, "trick_sys", Swig_var_trick_sys_get, Swig_var_trick_sys_set);
  SWIG_addvarlink(globals, "trick_mc", Swig_var_trick_mc_get, Swig_var_trick_mc_set);
  SWIG_addvarlink(globals, "trick_mm", Swig_var_trick_mm_get, Swig_var_trick_mm_set);
  SWIG_addvarlink(globals, "trick_cpr", Swig_var_trick_cpr_get, Swig_var_trick_cpr_set);
  SWIG_addvarlink(globals, "trick_sie", Swig_var_trick_sie_get, Swig_var_trick_sie_set);
  SWIG_addvarlink(globals, "trick_cmd_args", Swig_var_trick_cmd_args_get, Swig_var_trick_cmd_args_set);
  SWIG_addvarlink(globals, "trick_message", Swig_var_trick_message_get, Swig_var_trick_message_set);
  SWIG_addvarlink(globals, "trick_jit", Swig_var_trick_jit_get, Swig_var_trick_jit_set);
  SWIG_addvarlink(globals, "trick_ip", Swig_var_trick_ip_get, Swig_var_trick_ip_set);
  SWIG_addvarlink(globals, "trick_em", Swig_var_trick_em_get, Swig_var_trick_em_set);
  SWIG_addvarlink(globals, "trick_vs", Swig_var_trick_vs_get, Swig_var_trick_vs_set);
  SWIG_addvarlink(globals, "trick_data_record", Swig_var_trick_data_record_get, Swig_var_trick_data_record_set);
  SWIG_addvarlink(globals, "trick_real_time", Swig_var_trick_real_time_get, Swig_var_trick_real_time_set);
  SWIG_addvarlink(globals, "trick_frame_log", Swig_var_trick_frame_log_get, Swig_var_trick_frame_log_set);
  SWIG_addvarlink(globals, "trick_master_slave", Swig_var_trick_master_slave_get, Swig_var_trick_master_slave_set);
  SWIG_addvarlink(globals, "trick_instruments", Swig_var_trick_instruments_get, Swig_var_trick_instruments_set);
  SWIG_addvarlink(globals, "trick_inject", Swig_var_trick_inject_get, Swig_var_trick_inject_set);
  SWIG_addvarlink(globals, "trick_zero_conf", Swig_var_trick_zero_conf_get, Swig_var_trick_zero_conf_set);
  SWIG_addvarlink(globals, "trick_utest", Swig_var_trick_utest_get, Swig_var_trick_utest_set);
  SWIG_addvarlink(globals, "trick_udunits", Swig_var_trick_udunits_get, Swig_var_trick_udunits_set);
  SWIG_addvarlink(globals, "dyn", Swig_var_dyn_get, Swig_var_dyn_set);
  SWIG_addvarlink(globals, "dyn_integloop", Swig_var_dyn_integloop_get, Swig_var_dyn_integloop_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
